            ...
            <table border="1" cellspacing="0" cellpadding="5">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <input required="required" type="text" name="title" value="${review.title }" autocomplete="off"
                               placeholder="새 제목"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="text-center">
                        <input required="required" type="text" name="body" value="${review.body }" autocomplete="off"
                               placeholder="새 내용"/>
                    </td>
                </tr>
                <tr>
